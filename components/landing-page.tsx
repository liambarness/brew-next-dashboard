...
export default function LandingPage() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-amber-50 to-blue-100 flex flex-col items-center justify-center p-4 text-center">
      ...
      <main className="relative z-10 max-w-2xl mx-auto">
        ...
        <h1 className="text-4xl md:text-5xl font-bold text-amber-900 mb-4">Beach Brew</h1>
        <p className="text-xl md:text-2xl text-amber-800 mb-8">Employee Dashboard</p>
        ...
        <Button className="bg-amber-600 hover:bg-amber-700 text-white py-2 px-6 rounded-full text-lg transition duration-300 ease-in-out transform hover:scale-105">
          Access Dashboard
        </Button>
      </main>
